...
silhouette_score <- function(k){
  km <- kmeans(cluster_data, centers = k, nstart=15)
...
y_axis <- as.matrix(abs_mat_both_q_new$fracs_ctrl)
x_axis <- as.matrix(abs_mat_both_q_new$fracs_RNAse)
cols <- c(1,3)

p_all <- ggplot(abs_mat_both_q_new[,cols], aes(x = x_axis, y=y_axis), color = cyl) +
geom_point() +
