...
mean_20 <- function(x) {
              mean <- mean(x)
             if (abs(x[1] - mean) > 0.7 * mean) { x[1] <- NA}
              if (abs(x[2] - mean) > 0.7 * mean) { x[2] <- NA}
       if (abs(x[3] - mean) > 0.7 * mean) { x[3] <- NA}
...
mean_Ctrl1 <- apply(Fraction1_Ctrl, 1,mean_20)
mean_Ctrl2 <- apply(Fraction2_Ctrl, 1,mean_20 )
mean_Ctrl3 <- apply(Fraction3_Ctrl, 1,mean_20 )
mean_Ctrl4 <- apply(Fraction4_Ctrl, 1,mean_20 )
mean_Ctrl5 <- apply(Fraction5_Ctrl, 1,mean_20 )

mean_Ctrl6 <- apply(Fraction6_Ctrl, 1,mean_20)
mean_Ctrl7 <- apply(Fraction7_Ctrl, 1,mean_20)
mean_Ctrl8 <- apply(Fraction8_Ctrl, 1,mean_20)
mean_Ctrl9 <- apply(Fraction9_Ctrl, 1,mean_20)
mean_Ctrl10 <- apply(Fraction10_Ctrl, 1, mean_20)
mean_Ctrl11 <- apply(Fraction11_Ctrl, 1,mean_20)
mean_Ctrl12 <- apply(Fraction12_Ctrl, 1,mean_20)
mean_Ctrl13 <- apply(Fraction13_Ctrl, 1,mean_20)
mean_Ctrl14 <- apply(Fraction14_Ctrl, 1,mean_20)
mean_Ctrl15 <- apply(Fraction15_Ctrl, 1,mean_20)
mean_Ctrl16 <- apply(Fraction16_Ctrl, 1,mean_20)
mean_Ctrl17 <- apply(Fraction17_Ctrl, 1,mean_20)
mean_Ctrl18 <- apply(Fraction18_Ctrl, 1,mean_20)
mean_Ctrl19 <- apply(Fraction19_Ctrl, 1,mean_20)
mean_Ctrl20 <- apply(Fraction20_Ctrl, 1,mean_20)
mean_Ctrl21 <- apply(Fraction21_Ctrl, 1,mean_20)
mean_Ctrl22 <- apply(Fraction22_Ctrl, 1,mean_20)
mean_Ctrl23 <- apply(Fraction23_Ctrl, 1,mean_20)
mean_Ctrl24 <- apply(Fraction24_Ctrl, 1,mean_20)
mean_Ctrl25 <- apply(Fraction25_Ctrl, 1,mean_20)


mean_RNAse1 <- apply(Fraction1_RNAse, 1,mean_20)
mean_RNAse2 <- apply(Fraction2_RNAse, 1,mean_20)
mean_RNAse3 <- apply(Fraction3_RNAse, 1,mean_20)
mean_RNAse4 <- apply(Fraction4_RNAse, 1,mean_20)
mean_RNAse5 <- apply(Fraction5_RNAse, 1,mean_20)
mean_RNAse6 <- apply(Fraction6_RNAse, 1,mean_20)
mean_RNAse7 <- apply(Fraction7_RNAse, 1,mean_20)
mean_RNAse8 <- apply(Fraction8_RNAse, 1,mean_20)
mean_RNAse9 <- apply(Fraction9_RNAse, 1,mean_20)
mean_RNAse10 <- apply(Fraction10_RNAse, 1,mean_20)
mean_RNAse11 <- apply(Fraction11_RNAse, 1,mean_20)
mean_RNAse12 <- apply(Fraction12_RNAse, 1,mean_20)
mean_RNAse13 <- apply(Fraction13_RNAse, 1,mean_20)
mean_RNAse14 <- apply(Fraction14_RNAse, 1,mean_20)
mean_RNAse15 <- apply(Fraction15_RNAse, 1,mean_20)
mean_RNAse16 <- apply(Fraction16_RNAse, 1,mean_20)
mean_RNAse17 <- apply(Fraction17_RNAse, 1,mean_20)
mean_RNAse18 <- apply(Fraction18_RNAse, 1,mean_20)
mean_RNAse19 <- apply(Fraction19_RNAse, 1,mean_20)
mean_RNAse20 <- apply(Fraction20_RNAse, 1,mean_20)
mean_RNAse21 <- apply(Fraction21_RNAse, 1,mean_20)
mean_RNAse22 <- apply(Fraction22_RNAse, 1,mean_20)
mean_RNAse23 <- apply(Fraction23_RNAse, 1,mean_20)
mean_RNAse24 <- apply(Fraction24_RNAse, 1,mean_20)
mean_RNAse25 <- apply(Fraction25_RNAse, 1,mean_20)
