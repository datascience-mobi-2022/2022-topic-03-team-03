...
```{r}
#Frage: Falls das jemand über einen Link oder mit ~ hinbekommt
...
```{r}
#Skallieren/ in Prozente umrechnen
#Anmerkung: Das ist das was wir unter normieren gelistet hatten  Proteinamount/RowSum
#Falls jemand Zeit hat kann er/sie sich da gerne ransetzten wenn nicht versuch ichs Mo mal
```
