...
```{r calculating shift}
# help warum funktioniert das nicht?
fracs_ctrl[6]-fracs_RNAse[6]

for(i in 1:7081){abs_max_both$shifts <- abs_max_both$fracs_ctrl[i] - abs_max_both$fracs_RNAse[i]
}

#shift <- data.frame()
#for (i in 1:7081){
#  shift <- fracs_ctrl[i] - fracs_RNAse[i]
#}
#shift
```
