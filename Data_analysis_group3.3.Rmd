...
i <- c(1:7081)
shifts <- c()
for(x in i){shifts[x] <- fracs_ctrl[x] - fracs_RNAse[x]
}
abs_max_both$shifts <- shifts
...
To refer the F-test results back to the actual proteins, a more visaul matrix was created.
