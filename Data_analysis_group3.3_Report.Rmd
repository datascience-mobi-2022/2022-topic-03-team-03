...
or 2923 unique proteins all our methods resulted in the same classification.  723 True RBPs (TP), 478  non RBPs were classifed as actual non-RBPs (TN). 1020 proteins were falsely identified as true RBPs (FP) and  702 RBPs were not identified as RBPs (FN). This results in an overall precision of 41.48% and an accuracy of 41.09%.
