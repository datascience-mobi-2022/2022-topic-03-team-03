...
Norm_Ctrl_1 <- rowPercent(HeLa_Ctrl1)
Norm_Ctrl_2 <- rowPercent(HeLa_Ctrl2)
Norm_Ctrl_3 <- rowPercent(HeLa_Ctrl3)


Norm_RNAse_1 <- rowPercent(HeLa_RNAse1)
Norm_RNAse_2 <- rowPercent(HeLa_RNAse2)
Norm_RNAse_3 <- rowPercent(HeLa_RNAse3)

```

```{r}
Norm_HeLa <- data.frame(Norm_Ctrl_1, Norm_Ctrl_2, Norm_Ctrl_3, Norm_RNAse_1, Norm_RNAse_2, Norm_RNAse_3)
# vector <- for (i in 0:24 ) {
           #a <- 1 +i
         # b <- 26 +i
         #c <- 51 +i 
        # d <- 76 + i
